...
{
	//  1d,     1e,      26
	{ 0x72,   0x74,    0x04}, // Bw125Cr45Sf128,	AGC enabled (the chip default)
...
void RH_RF95::handleInterrupt()
{
	...
	else if (_mode == RHModeRx && irq_flags & RH_RF95_RX_DONE)
	{
		...
		// Per page 111, SX1276/77/78/79 data sheet
		...
		// Adjust the RSSI, data sheet page 87
		if (_lastSNR < 0)
