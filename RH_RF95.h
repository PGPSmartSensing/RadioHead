...
/// \brief Driver to send and receive un-addressed, unreliable datagrams via a LoRa 
...
/// SPI based device, that you disable interrupts while you transfer data to
...
/// flash program memory of most Arduinos. However, the RAM requirements are
...
public:
    ...
    /// Restart the Driver transport hardware after sleep period.
